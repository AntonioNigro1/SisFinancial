...
export const Form = () => {
  ...
  const { control, handleSignup, handleSubmit, isValid, resetForm } = useAccountForm(accountType);
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(handleSignup)} className="w-full h-full flex flex-col items-center gap-2">
